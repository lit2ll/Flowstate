...
type SessionCard = {
  type: 'Private Training' | 'Small Class Training' | 'Workshop (Coming Soon)'
...
export default function ScheduleClient() {
  ...
  useEffect(() => {
    ...
    toast.success({
      ...
      description: pkg
        ? `Package: ${pkg}. Book your session below.`
  ...
  const sessions: SessionCard[] = useMemo(
    () => [
      ...
      {
        type: 'Workshop (Coming Soon)',
        icon: <MapPin className='w-8 h-8' />,
        description:
          'Laser focused workshop on specific skills or concepts. e.g. Footwork, Punching Power, etc.',
        duration: '3 hours',
        price: 'Paid during booking',
  ...
  const weekSchedule = [
    {
      day: 'Monday',
      sessions: [
        { time: '7:00 AM - 8:00 AM', type: 'Class Training', spots: '5 spots left' }
      ]
    },
    {
      day: 'Tuesday',
      sessions: [
        { time: '6:30 PM - 7:30 AM', type: 'Class Training', spots: '5 spots left' }
      ]
    },
    {
      day: 'Wednesday',
      sessions: [
        { time: '6:30 PM - 7:30 PM', type: 'Class Training', spots: '2 spots left' }
      ]
    },
    {
      day: 'Thursday',
      sessions: [
        { time: '5:30 PM - 6:30 PM', type: 'Class Training', spots: '2 spots left' },
        { time: '6:30 PM - 7:30 PM', type: 'Class Training', spots: 'Available' }
      ]
    },
    {
      day: 'Friday',
      sessions: [
        { time: '6:00 PM - 7:30 PM', type: 'Class Training', spots: 'Full' },
        { time: '7:30 PM - 9:00 PM', type: 'Class Training', spots: 'Full' }
      ]
    },
    {
      day: 'Saturday',
      sessions: [
        { time: '8:00 AM - 9:00 AM', type: 'Class Training', spots: 'Available' }
      ]
    },
    {
      day: 'Sunday',
          ...
          <div className='container mx-auto max-w-4xl'>
            ...
            >
              <div className='text-center'>
                ...
                <p className='text-white/60'>Small Class Training availability</p>
              </div>
            ...
            >
              ...
              <div className='space-y-6 text-white/70 leading-relaxed'>
                <div className='bg-black/20 border border-white/5 rounded-xl p-6'>
                  ...
                  <p>
                    Your first session includes a brief consultation to discuss your
                    goals, assess your current level, and answer any questions. Arrive 10
                    minutes early.
                  </p>
                </div>
                ...
                <div className='bg-black/20 border border-white/5 rounded-xl p-6'>
                  ...
                  <p>
                    ...
                    cancellations may be charged the full session fee.
                  </p>
                </div>
              </div>
            </motion.div>
