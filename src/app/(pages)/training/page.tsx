        ...
        <div className='container mx-auto max-w-4xl'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-white/60 max-w-3xl mx-auto leading-relaxed'>
              A systematic approach to developing striking skills that emphasizes
              awareness, efficiency, and intelligent progression.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className='container mx-auto max-w-4xl'>
          ...
          >
            ...
            <p className='text-lg text-white/70 leading-relaxed max-w-2xl mx-auto'>
              When technique becomes instinct. When you stop thinking and start flowing.
              That's the state we're training for—where skill expression feels effortless
              because the foundation is rock solid.
            </p>
          </motion.div>
        </div>
      </section>
