						...
						>
							<div className='space-y-6'>
								...
								<p className='text-white/70 leading-relaxed'>
									Whether you're completely new to martial arts or looking to refine existing
									skills, reach out with any questions. I'm happy to discuss your goals and see if
									Flow State Striking is the right fit.
								</p>
							</div>
				...
				<div className='container mx-auto max-w-4xl'>
					...
					>
						...
						<p className='text-lg text-white/60 max-w-2xl mx-auto'>
							Stop by during regular training hours to see the facility and meet the coach. No
