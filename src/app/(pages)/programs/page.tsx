...
//       title: 'Private Training - Single Session',
...
//               Choose the path that fits your schedule. Train in Flow. Train for life.
//             </p>
//           </motion.div>
//         </div>
//       </section>
...
//                         {program.title}
//                       </h2>
//                       <p className='text-emerald-500/80 font-medium text-lg'>
//                         {program.tagline}
//                       </p>
//                     </div>
...
//                     <ProgramButton link={program.link ?? '/schedule'} />
//                   </div>
...
//               Book a complimentary consultation to discuss your goals and find the best
//               fit for your training journey.
//             </p>
//             <Button
...
export const metadata = {
  title: 'Programs | Flow State Striking',
  description:
    'Private training, small group training, and workshops rooted in Boxing, Muay Thai, and Kickboxing—built for clarity, progress, and longevity.'
}
