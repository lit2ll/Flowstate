				...
				<div className='grid gap-4 md:grid-cols-5'>
					...
					<Card className='md:col-span-3'>
						<p className='text-white/85 leading-relaxed'>
							...
							kickboxing, Larry Ly focuses on helping students develop skill, confidence, and
							control — without unnecessary damage.
						</p>
						<p className='mt-4 text-white/80 leading-relaxed'>
							Flow State Striking blends science, experience, and philosophy into a system that
